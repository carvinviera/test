...
// test.describe('Test en Home La Nacion', () => {

//     // const response = [''];
//     // test('Navegar la Home de La Nacion', async ({ page }) => {
//     //     response[0] = await Promise.all([
//     //         (await page.waitForEvent('response', response => response.request().resourceType() === 'document'))
//     //         .status()
//     //     ]);
...
//     // test('Botones "SUSCRIBITE" visibles y clickeables', async ({ page }) => {
//     //     await expect(page.locator('#btnsuscribite')).toBeVisible();
//     //     await page.locator('#btnsuscribite').click();
//     //   });

//     // test('Botones "INGRESAR" visibles y clickeables', async ({ page }) => {
//     //     await expect(page.locator('#btningresar')).toBeVisible();
//     //     await page.locator('#btningresar').click();
//     // });

//     test('Click first Article', async ({ page }) => {
//         // await page.locator('.todo-list li .toggle').first().click();
//         // await page.locator('#btningresar').click();

//         /*const elements = */await page.locator('article').first().click();
